...
- **Custom Global Skills**: Created on-demand progressive disclosure playbooks for `conventional-release`, `rigorous-pr-review`, and Sentry `code-review` (engineering practices, ORM optimization, and feedback guidelines).
